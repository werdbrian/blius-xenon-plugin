...
#pragma pack(pop)
    ...
    public:
        ...
        SkillCooldown GetUltDuration() const { return { m_data.ultDuration.current, m_data.ultDuration.max, m_data.ultDuration.enabled != 0 }; }
